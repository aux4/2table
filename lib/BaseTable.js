  ...
  buildCells() {
    this.structure.forEach(structureItem => {
      ...
      if (structureItem.group && Array.isArray(this.item[structureItem.key])) {
        ...
        // console.error(`DEBUG: BaseNestedDataRow processing array ${structureItem.key}, arrayIndex=${this.arrayIndex}, arrayLength=${arrayValue.length}`);
            ...
            if (value && typeof value === 'object') {
              const nestedCellValues = structureItem.group.map(groupItem => {
                ...
                if (nestedValue === undefined || nestedValue === null) {
                  ...
                  if (groupItem.group) {
                    // Array with structure - create recursive table
                    // console.error(`DEBUG: Creating recursive table for array ${groupItem.key} with structure`);
                    ...
                    nestedValue = this.table.removeWhitespace ? this.table.removeWhitespace(recursiveTable.print()) : recursiveTable.print().trim();
                  } else {
